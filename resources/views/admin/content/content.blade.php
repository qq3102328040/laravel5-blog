    ...
    <div class="row">
        ...
        <div class="col-md-3">
                ...
                <div class="container">
                    <ul class="list-unstyled">
                        @foreach($categorys as $category)
                            <li>
                                <input type="checkbox" name="category[]" value="{{ $category->mid }}" id="category-id-{{ $category->mid }}" form="form1"<?php if(isset($categorysChecked)){if(in_array($category, $categorysChecked)){echo 'checked';}} ?>
            ...
            <div>
                <h4>标签</h4>
                <div class="container">
                    <input type="text" name="tag" class="" form="form1" value="{{ isset($tagsChecked) ? $tagsChecked : ''}}">
                </div>
            </div>
        </div>
    </div>
